...
//        tagSortEngine.container.html(''); //__JK__
            ...
            $.each(elementTags, function(key, v) {
              ...
              if (!tags_inclusive[tagPropertyName]) {
                ...
                if(tagSortEngine.options.selectedTags.includes(tagName))
                  tag.addClass('active');
//                tagSortEngine.container.append(tag); //__JK__
              }
      ...
      exclusiveSort: function(tags) {
        ...
        $('#active-item-count').html(count); //__JK__
        return display;
      },
...
//                tagSortEngine.container.append(value); //__JK__
            });
        }
        tagSortEngine.sort();
